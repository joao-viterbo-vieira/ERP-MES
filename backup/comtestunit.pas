...
procedure TFormComTest.BconnectClick(Sender: TObject);
var result : integer;
var msg : string;
begin
        result:=M_connect();
...
procedure TFormComTest.Bdo_expeditionClick(Sender: TObject);
var r: integer;
var msg : string;
begin
...
procedure TFormComTest.Bdo_scratchClick(Sender: TObject);
var r: integer;
var msg : string;
begin
...
procedure TFormComTest.Bget_freeClick(Sender: TObject);
var r: integer;
var msg : string;
begin
     r:=M_Get_Free();
...
procedure TFormComTest.Bget_part_qualityClick(Sender: TObject);
var r: integer;
var msg : string;
begin
...
procedure TFormComTest.BinitializeClick(Sender: TObject);
var r: integer;
var msg : string;
begin
...
procedure TFormComTest.Bget_part_infoClick(Sender: TObject);
var r: integer;
var msg : string;
begin
...
procedure TFormComTest.Bdo_inboundClick(Sender: TObject);
var r: integer;
var msg : string;
begin
...
procedure TFormComTest.Bdo_productionClick(Sender: TObject);
var r: integer;
var msg : string;
begin
...
procedure TFormComTest.Bset_part_defectClick(Sender: TObject);
var r: integer;
var msg : string;
begin
...
procedure TFormComTest.BunloadClick(Sender: TObject);
var r: integer;
var msg : string;
begin
...
procedure TFormComTest.Bget_storedClick(Sender: TObject);
var r: integer;
var msg : string;
begin
...
procedure TFormComTest.BDisconnectClick(Sender: TObject);
var r: integer;
var msg : string;
begin
        r:=M_Disconnect();
...
procedure TFormComTest.Button1Click(Sender: TObject);
...
procedure TFormComTest.BloadClick(Sender: TObject);
var r: integer;
var msg : string;
begin
...
procedure TFormComTest.Bget_factory_statusClick(Sender: TObject);
begin
...
var
  i: integer;
  r: array[1..status_response_size] of integer;;
begin
     r:=M_Get_Factory_Status();

     FormComTest.Memo2.clear;
     for i:=1 to status_response_size do
         FormComTest.Memo2.append('['+floattostr(i)+'] ' + M_status_msg[i]+'='+floattostr(r[i]));

end;

procedure TFormComTest.FormCreate(Sender: TObject);
begin

end;

procedure TFormComTest.Label4Click(Sender: TObject);
begin

end;

procedure TFormComTest.Label5Click(Sender: TObject);
begin

end;

procedure TFormComTest.Memo1Change(Sender: TObject);
begin

end;

procedure TFormComTest.Timer1Timer(Sender: TObject);
var i: integer;
var r: status_values;
begin
